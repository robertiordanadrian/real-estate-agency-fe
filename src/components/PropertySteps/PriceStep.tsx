            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <TextField
                  ...
                  onChange={(e) => handlePriceChange("pricePerMp", e.target.value)}
                  fullWidth
                  slotProps={{
                    input: {
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    label="Metoda plata"
                    onChange={(e) => handlePriceChange("paymentMethod", e.target.value)}
                  >
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <TextField
                  ...
                  onChange={(e) => handlePriceChange("garagePrice", e.target.value)}
                  fullWidth
                  slotProps={{
                    input: {
                      endAdornment: <InputAdornment position="end">€</InputAdornment>,
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <TextField
                  ...
                  onChange={(e) => handlePriceChange("parkingPrice", e.target.value)}
                  fullWidth
                  slotProps={{
                    input: {
                      endAdornment: <InputAdornment position="end">€</InputAdornment>,
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <TextField
                  ...
                  onChange={(e) => handlePriceChange("privateNotePrice", e.target.value)}
                  fullWidth
                />
              </Grid>
            </Grid>
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => handlePriceChange("negociablePrice", e.target.checked)}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => handlePriceChange("requestPrice", e.target.checked)}
                    />
                  }
                ...
                <FormControlLabel
                  control={
                    <Switch
                      ...
                      onChange={(e) => handlePriceChange("showPricePerMp", e.target.checked)}
                    />
                  }
                  label="Afiseaza €/mp"
                />
            ...
            <Grid container spacing={2}>
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField
                  ...
                  onChange={(e) => handleCommissionsChange("buyerCommission", e.target.value)}
                  fullWidth
                />
              </Grid>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField
                  ...
                  onChange={(e) => handleCommissionsChange("buyerCommissionValue", e.target.value)}
                  fullWidth
                  slotProps={{
                    input: {
                      endAdornment: <InputAdornment position="end">€</InputAdornment>,
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField
                  ...
                  onChange={(e) => handleCommissionsChange("ownerCommission", e.target.value)}
                  fullWidth
                />
              </Grid>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 3 }}>
                <TextField
                  ...
                  onChange={(e) => handleCommissionsChange("ownerCommissionValue", e.target.value)}
                  fullWidth
                  slotProps={{
                    input: {
                      endAdornment: <InputAdornment position="end">€</InputAdornment>,
            ...
            <Grid container spacing={2}>
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <FormControl fullWidth>
                  ...
                  <Select
                    ...
                    onChange={(e) => handleContactChange("signedContract", e.target.value)}
                  >
              ...
              <Grid size={{ xs: 12, sm: 6, md: 4 }}>
                <TextField
                  ...
                  onChange={(e) => handleContactChange("contractNumber", e.target.value)}
                  fullWidth
                />
              </Grid>
